...
<svelte:head>
    ...
    <meta property="og:title" content="{i18n.t('donate:metaTitle')} - Sensor.Community">
    <meta property="og:description" content="{i18n.t('donate:metaDescription')}">

    <!-- Twitter -->
    <meta property="twitter:card" content="summary_large_image">
    <meta property="twitter:url" content="https://sensor.community{$page.path}">
    <meta property="twitter:title" content="{i18n.t('donate:metaTitle')} - Sensor.Community">
    <meta property="twitter:description" content="{i18n.t('donate:metaDescription')}">
</svelte:head>
