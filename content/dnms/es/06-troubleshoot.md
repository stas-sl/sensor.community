...
* ¿Se registra el sensor a través de [https://devices-test.sensor.community/register](https://devices-test.sensor.community/register) y es el sensor visible en el mapa?
